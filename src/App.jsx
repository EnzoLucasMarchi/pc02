    ...
    <>
      <div className='page'>
        ...
        <div className='page-header'>
          <h1 className='page-title'><span className='blanquita'>Reliable, efficient delivery</span><br/><span className='negrita'> Powered by technology</span></h1>
          <p className='page-subtitle'><span>our artificial intelligence powered tools use millions of projects data </span><br/><span>points to ensure that your project is successful</span></p>
        </div>
